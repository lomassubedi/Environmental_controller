...
int8_t mqttToFrameSetProf(char * prof_num, char * profile_var_name, char * var_command, uint8_t * f, uint16_t * fLen) {
	...
	switch(profInt) {
		...
		case 0:
			if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_DeviceType])) {
				f[indx++] = var_code_Ad1_DeviceType;	
				f[indx++] = sizeof(uint8_t);								// number of Bytes
				if(getIntArg(var_command) >= 0) 
					f[indx++] = getIntArg(var_command);		// data Byte
				else
					return MSG_ERROR;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_Units_EnglishMetric])) {
				f[indx++] = var_code_Ad1_Tools_Units_EnglishMetric;	
				f[indx++] = 1;								// number of Bytes
				if(getIntArg(var_command) >= 0) 
					f[indx++] = getIntArg(var_command);		// data Byte
				else
					return MSG_ERROR;				
			}  else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_Sensor_Fault])) {
				f[indx++] = var_code_Ad1_Tools_Sensor_Fault;	
				f[indx++] = 1;								// number of Bytes
				if(getIntArg(var_command) >= 0) 
					f[indx++] = getIntArg(var_command);		// data Byte
				else
					return MSG_ERROR;				
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_ACFault_Message_YesNo])) {
				f[indx++] = var_code_Ad1_Tools_ACFault_Message_YesNo;	
				f[indx++] = 1;								// number of Bytes
				if(getIntArg(var_command) >= 0) 
					f[indx++] = getIntArg(var_command);		// data Byte
				else
					return MSG_ERROR;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_LoTemp_Warning_YesNo])) {
				f[indx++] = var_code_Ad1_Tools_LoTemp_Warning_YesNo;	
				f[indx++] = 1;								// number of Bytes
				if(getIntArg(var_command) >= 0) 
					f[indx++] = getIntArg(var_command);		// data Byte
				else
					return MSG_ERROR;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_LoTemp_Warning_StPt])) {
				float fv = 0.0;
				f[indx++] = var_code_Ad1_Tools_LoTemp_Warning_StPt;
				...
				indx += bytes_n;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_HiTemp_Warning_YesNo])) {
				f[indx++] = var_code_Ad1_Tools_HiTemp_Warning_YesNo;	
				f[indx++] = 1;								// number of Bytes
				if(getIntArg(var_command) >= 0) 
					f[indx++] = getIntArg(var_command);		// data Byte
				else
					return MSG_ERROR;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_HiTemp_Warning_StPt])) {
				float fv = 0.0;
				f[indx++] = var_code_Ad1_Tools_HiTemp_Warning_StPt;
				bytes_n = sizeof(float);
				f[indx++] = bytes_n;
				...
				indx += bytes_n;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_LoHum_Warning_YesNo])) {
				f[indx++] = var_code_Ad1_Tools_LoHum_Warning_YesNo;	
				f[indx++] = 1;								// number of Bytes
				if(getIntArg(var_command) >= 0) 
					f[indx++] = getIntArg(var_command);		// data Byte
				else
					return MSG_ERROR;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_LoHum_Warning_StPt])) {
				float fv = 0.0;
				f[indx++] = var_code_Ad1_Tools_LoHum_Warning_StPt;
				bytes_n = sizeof(float);
				f[indx++] = bytes_n;
				...
				indx += bytes_n;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_HiHum_Warning_YesNo])) {
				f[indx++] = var_code_Ad1_Tools_HiHum_Warning_YesNo;	
				f[indx++] = 1;								// number of Bytes
				if(getIntArg(var_command) >= 0) 
					f[indx++] = getIntArg(var_command);		// data Byte
				else
					return MSG_ERROR;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_HiHum_Warning_StPt])) {
				float fv = 0.0;
				f[indx++] = var_code_Ad1_Tools_HiHum_Warning_StPt;
				bytes_n = sizeof(float);
				f[indx++] = bytes_n;
				...
				indx += bytes_n;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_Critical_OverTemp_Fault_YesNo])) {
				f[indx++] = var_code_Ad1_Tools_Critical_OverTemp_Fault_YesNo;	
				f[indx++] = 1;								// number of Bytes
				if(getIntArg(var_command) >= 0) 
					f[indx++] = getIntArg(var_command);		// data Byte
				else
					return MSG_ERROR;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_Critical_OverTemp_Fault_Flag])) {
				f[indx++] = var_code_Ad1_Tools_Critical_OverTemp_Fault_Flag;	
				f[indx++] = 1;								// number of Bytes
				if(getIntArg(var_command) >= 0) 
					f[indx++] = getIntArg(var_command);		// data Byte
				else
					return MSG_ERROR;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_Critical_OverTemp_StPt])) {
				float fv = 0.0;
				f[indx++] = var_code_Ad1_Tools_Critical_OverTemp_StPt;
				bytes_n = sizeof(float);
				f[indx++] = bytes_n;
				...
				indx += bytes_n;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_Critical_OverTemp_Response])) {
				f[indx++] = var_code_Ad1_Tools_Critical_OverTemp_Response;	
				f[indx++] = 1;								// number of Bytes
				if(getIntArg(var_command) >= 0) 
					f[indx++] = getIntArg(var_command);		// data Byte
				else
					return MSG_ERROR;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_Critical_OverTemp_Message_YesNo])) {
				f[indx++] = var_code_Ad1_Tools_Critical_OverTemp_Message_YesNo;	
				f[indx++] = 1;								// number of Bytes
				if(getIntArg(var_command) >= 0) 
					f[indx++] = getIntArg(var_command);		// data Byte
				else
					return MSG_ERROR;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_ReStrike_Fault_YesNo])) {
				f[indx++] = var_code_Ad1_Tools_ReStrike_Fault_YesNo;	
				f[indx++] = 1;								// number of Bytes
				if(getIntArg(var_command) >= 0) 
					f[indx++] = getIntArg(var_command);		// data Byte
				else
					return MSG_ERROR;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_ReStrike_Delay_Time])) {
				f[indx++] = var_code_Ad1_Tools_ReStrike_Delay_Time;	
			...
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_ReStrike_Message_YesNo])) {
				f[indx++] = var_code_Ad1_Tools_ReStrike_Message_YesNo;	
				f[indx++] = 1;								// number of Bytes
				if(getIntArg(var_command) >= 0) 
					f[indx++] = getIntArg(var_command);		// data Byte
				else
					return MSG_ERROR;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_LoBat_Fault_Message_YesNo])) {
				f[indx++] = var_code_Ad1_Tools_LoBat_Fault_Message_YesNo;	
				f[indx++] = 1;								// number of Bytes
				if(getIntArg(var_command) >= 0) 
					f[indx++] = getIntArg(var_command);		// data Byte
				else
					return MSG_ERROR;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_Batt_Current_Volt])) {
				float fv = 0.0;
				f[indx++] = var_code_Ad1_Tools_Batt_Current_Volt;
				bytes_n = sizeof(float);
				f[indx++] = bytes_n;
				...
				indx += bytes_n;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_Light_Relay_Cycle_Counter])) {
				uint16_t iv = 0;
				f[indx++] = var_code_Ad1_Tools_Light_Relay_Cycle_Counter;
			...
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_HdVent_Relay_Cycle_Counter])) {
				uint16_t iv = 0;
				f[indx++] = var_code_Ad1_Tools_HdVent_Relay_Cycle_Counter;
				bytes_n = sizeof(uint16_t);
				f[indx++] = bytes_n;
				...
				indx += sizeof(uint16_t);
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_Circ_Relay_Cycle_Counter])) {
				uint16_t iv = 0;
				f[indx++] = var_code_Ad1_Tools_Circ_Relay_Cycle_Counter;
				bytes_n = sizeof(uint16_t);
				f[indx++] = bytes_n;
				...
				indx += sizeof(uint16_t);
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_Vent_Relay_Cycle_Counter])) {
				uint16_t iv = 0;
				f[indx++] = var_code_Ad1_Tools_Vent_Relay_Cycle_Counter;
				bytes_n = sizeof(uint16_t);
				f[indx++] = bytes_n;
				...
				indx += sizeof(uint16_t);
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_FXP1_Relay_Cycle_Counter])) {
				uint16_t iv = 0;
				f[indx++] = var_code_Ad1_Tools_FXP1_Relay_Cycle_Counter;
				bytes_n = sizeof(uint16_t);
				f[indx++] = bytes_n;
				...
				indx += sizeof(uint16_t);
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_FXP2_Relay_Cycle_Counter])) {
				uint16_t iv = 0;
				f[indx++] = var_code_Ad1_Tools_FXP2_Relay_Cycle_Counter;
				bytes_n = sizeof(uint16_t);
				f[indx++] = bytes_n;
				...
				indx += sizeof(uint16_t);
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_Switch_YesNo])) {
				f[indx++] = var_code_Ad1_Tools_Switch_YesNo;	
				f[indx++] = 1;								// number of Bytes
				if(getIntArg(var_command) >= 0) 
					f[indx++] = getIntArg(var_command);		// data Byte
				else
					return MSG_ERROR;
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_HdVent_DC_DeAct_FactSet_Delay])) {
				f[indx++] = var_code_Ad1_Tools_HdVent_DC_DeAct_FactSet_Delay;	
				bytes_n = sizeof(TIME_M);
				f[indx++] = bytes_n;						// number of Bytes
			...
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_CO2_PVA_PostVent_FactSet_Delay])) {
				f[indx++] = var_code_Ad1_Tools_CO2_PVA_PostVent_FactSet_Delay;	
				bytes_n = sizeof(TIME_M);
				f[indx++] = bytes_n;						// number of Bytes
			...
			} else if(!strcmp(profile_var_name, varCodeTools[var_code_Ad1_Tools_LED_OnOff])) {
				f[indx++] = var_code_Ad1_Tools_LED_OnOff;	
				f[indx++] = 1;								// number of Bytes
				if(getIntArg(var_command) >= 0) 
					f[indx++] = getIntArg(var_command);		// data Byte
				else
...
int8_t mqttToFrameGetProf(char * prof_num, char * profile_var_name, uint8_t * f, uint16_t * fLen) {
	...
	f[indx++] = SLAVE_ID;			// Slave ID 
	f[indx++] = FUNC_READ_VAR;		// Function Code
	f[indx++] = profInt;			// Profile Number

	uint16_t varCode = 0;

	if(profInt) {
		for(varCode = 0; varCode < var_code_prof_end; varCode++) {
			if(strcmp(profile_var_name, varNameProfile[varCode]) == 0) {
				f[indx++] = varCode;
				break;
			}
		}
	} else {
		for(varCode = 0; varCode < var_code_tools_end; varCode++) {
			if(strcmp(profile_var_name, varCodeTools[varCode]) == 0) {
				f[indx++] = varCode;
				break;
			} 
		}		
